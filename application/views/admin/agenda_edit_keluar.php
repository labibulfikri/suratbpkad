 <form enctype="multipart/form-data" action="<?php echo base_url() ?>admin/agenda/agenda_edit_keluar" method="post">
     <div class="row">
         ...
         <div class="col-md-6">
             <div class="form-group">
                 ...
                 <input type="hidden" name="agenda_dari" value="<?php echo $get_data['agenda_dari'] ?>" class="form-control">
                 <input type="text" name="agenda_no_keluar" value="<?php echo $get_data['agenda_no_keluar'] ?>" class="form-control">
             </div>
         </div>
         ...
         <div class="col-md-6">
             <div class="form-group">
                 ...
                 <?php } else { ?>
                     ...
                     <hr>
                     <input readonly hidden type="text" class="form-control" value="<?php echo $get_data['nama_agenda'] ?>" name="old_agenda">
