 <form enctype="multipart/form-data" action="<?php echo base_url() ?>admin/agenda/do_agenda_edit" method="post">
     <div class="row">
         ...
         <div class="col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="no_agenda" readonly value="<?php echo $get_data['no_agenda'] ?>" class="form-control">
             </div>
         </div>
         ...
         <div class="col-md-6">
             <div class="form-group">
                 ...
                 <!-- <?php
                     ...
                     <br>
                     <input readonly type="text" class="form-control" value="<?php echo $get_data['nama_agenda'] ?>" name="old">
