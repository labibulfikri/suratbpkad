<form enctype="multipart/form-data" action="<?php echo base_url() ?>admin/agenda/tambah" method="post">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input readonly type="text" value="<?php echo $kode ?>" name="no_agenda" class="form-control" required="">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="agenda_no_masuk" class="form-control" required="">
            </div>
        </div>
