 <form action="<?php echo base_url() ?>admin/surat/disposisi_sub_proses" method="post">
     <div class="row">
         ...
         <div class="col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" hidden name="id_surat_disposisi" value="<?php echo $get_data['id_surat_disposisi'] ?>" class="form-control">
         ...
         <div class="col-md-6">
             <div class="form-group">
                 ...
                 <div class="form-check">
                     <input type="checkbox" name="disposisi_keterangan[]" value="ke saya;">
                     <label class="form-check-label">
                         Ke Saya
                     </label>
                 </div>
                 <div class="form-check">
                     <input type="checkbox" name="disposisi_keterangan[]" value="koordinasikan;">
                     <label class="form-check-label">
                         Koordinasikan
                     </label>
                 </div>
                 <div class="form-check disabled">
                     <input type="checkbox" name="disposisi_keterangan[]" value="pantau progresnya;">
                     <label class="form-check-label">
                         Pantau Progresnya
                     </label>
                 </div>
                 <div class="form-check">
                     <input type="checkbox" name="disposisi_keterangan[]" value="pelajari;">
                     <label class="form-check-label">
                         Pelajari
                     </label>
                 </div>
                 <div class="form-check">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Rapat-koordinasikan;">
                     <label class="form-check-label">
                         Rapat - Koordinasikan
                     </label>
                 </div>
                 <div class="form-check disabled">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Segera! Jangan Terlambat;">
                     <label class="form-check-label">
                         Segera! Jangan Terlambat
                     </label>
                 </div>
                 <div class="form-check">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Siapkan;">
                     <label class="form-check-label">
                         Siapkan
                     </label>
                 </div>
                 <div class="form-check">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Infokan;">
                     <label class="form-check-label">
                         Infokan
                     </label>
                 </div>
                 <div class="form-check disabled">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Tindaklanjut ( TL );">
                     <label class="form-check-label">
                         Tindaklanjut ( TL )
                     </label>
                 </div>
                 <div class="form-check">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Untuk Diketahui (UDK);">
                     <label class="form-check-label">
                         Untuk Diketahui (UDK)
                     </label>
                 </div>
                 <div class="form-check">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Untuk Menjadi Perhatian (UMP);">
                     <label class="form-check-label">
                         Untuk Menjadi Perhatian (UMP)
                     </label>
                 </div>
                 <div class="form-check disabled">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Hadir;">
                     <label class="form-check-label">
                         Hadir
                     </label>
                 </div>
                 <div class="form-check disabled">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Ikut Hadir;">
                     <label class="form-check-label">
                         Ikut Hadir
                     </label>
                 </div>
                 <div class="form-check disabled">
                     <input type="checkbox" name="disposisi_keterangan[]" value="Laporkan Hasilnya;">
                     <label class="form-check-label">
                         Laporkan Hasilnya
                     </label>
                 </div>
                 ...
                 <div class="form-check disabled">
                     ...
                     <input class="form-control" type="text" name="disposisi_keterangan[]">
                 </div>
             </div>
         </div>
